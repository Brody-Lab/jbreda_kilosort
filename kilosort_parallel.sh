...
#SBATCH -o /scratch/gpfs/jbreda/ephys/kilosort/W122/logs_memory_rerun/output_%a_%j.out
#SBATCH -e /scratch/gpfs/jbreda/ephys/kilosort/W122/logs_memory_rerun/error_%a_%j.err
